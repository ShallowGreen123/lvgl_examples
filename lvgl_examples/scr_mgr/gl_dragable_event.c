...
{
    lv_obj_add_event_cb(obj, gl_drag_event_cb, LV_EVENT_PRESSED, rdy_cb);
    lv_obj_add_event_cb(obj, gl_drag_event_cb, LV_EVENT_PRESSING, rdy_cb);
    lv_obj_add_event_cb(obj, gl_drag_event_cb, LV_EVENT_RELEASED, rdy_cb);
    lv_obj_add_event_cb(obj, gl_drag_event_cb, LV_EVENT_PRESS_LOST, rdy_cb);
}
